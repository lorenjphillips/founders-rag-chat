...
const AuthModal = ({ isOpen, onOpenChange }: AuthModalProps) => {
  const handleGoogleLogin = () => {
    // Google auth logic will be implemented here when Supabase is connected
    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader className="text-center">
          ...
          <DialogTitle className="font-serif text-xl">Welcome to Founders Agent</DialogTitle>
          <DialogDescription className="text-muted-foreground">
            Sign in to save your conversations and access your chat history across devices.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 mt-6">
          ...
          <div className="text-xs text-center text-muted-foreground px-4">
            ...
            Your conversations will be securely stored and synced across devices.
          </div>
        </div>
      </DialogContent>
    </Dialog>
